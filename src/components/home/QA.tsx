...
const QA = () => {
  ...
  const answers = [
    ...
    "Для размещения иногородних гостей будут работать гостиницы ДВФУ. Чтобы забронировать номер, необходимо заполнить <a target='_blank' href='https://forms.yandex.ru/cloud/65dc6f4cc417f30452f555e8/'><b><u>форму</u></b></a>. Стоимость проживания для групп 450 рублей с каждого школьника, 450 рублей - 1 сопровождающий. Если приезжаете семьей, то 1700 с человека."
  ]
