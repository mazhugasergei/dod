...
const QA = () => {
  ...
  const answers = [
    ...
    "Для размещения иногородних гостей будут работать гостиницы ДВФУ. Чтобы забронировать номер, необходимо заполнить форму. Стоимость проживания для групп 450 рублей с каждого школьника, 450 рублей - 1 сопровождающий. Если приезжаете семьей, то 1700 с человека."
  ]
