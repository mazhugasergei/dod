        ...
        <div className="container">
          ...
          <div className="item">
            ...
            <div className="right lightblue">
              ...
              <p>Русский язык: ЕГЭ (ГИА-11). Как писать сочинение по русскому языку. Консультация для школьников от председателя предметной комиссии ЕГЭ по русскому языку Панченко Татьяны Федоровны.</p>
              <h4>14:00 - 15:30</h4>
              <p>Встреча со студентами «Как пережить ЕГЭ? Личный опыт». Студенты ДВФУ разных курсов и направлений расскажут о выборе профессии, о том, как готовиться к экзаменам и не выгореть, о поддержке, ожиданиях и результатах.   
