        ...
        <div className="container">
          ...
          <div className="item">
            ...
            <div className="right lightblue">
              ...
              <p>Русский язык: ЕГЭ (ГИА-11). Как писать сочинение по русскому языку. Консультация для школьников от председателя предметной комиссии ЕГЭ по русскому языку Панченко Татьяны Федоровны.</p>
              <h4>14:00 - 15:30</h4>
              <p>Встреча со студентами «Как пережить ЕГЭ? Личный опыт». Тема поступления волнует всех одиннадцатиклассников России. Выбор направления обучения, сдача ЕГЭ, ожидания родителей, давление в школе, стресс, страх, предрассудки… Как пережить все это и не сойти с ума!? Обо всем и поговорим 1 апреля во время Дня открытых дверей ДВФУ! 
Приглашённые спикеры – студенты ДВФУ разных курсов и направлений расскажут о выборе профессии, о том, как готовиться к экзаменам и не выгореть, о поддержке, ожиданиях и результатах.  
Модератор: Черепнина Валерия, студентка 1 курса направления «Конфликтология», старший наставник.</p>
            </div>
          </div>
        </div>
