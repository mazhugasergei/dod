        ...
        <div className="container">
          ...
          <div className="item">
            ...
            <div className="right blue">
              ...
              <h4>10:00 - 16:00</h4>
              <p>Дополнительное профессиональное обучение (доп)</p>
              <h4>10:00 - 16:00</h4>
              <p>Международные программы и стажировки (иконка - глобус)</p>
              <h4>10:00 - 16:00</h4>
              <p>Представители банков. Образовательные кредиты (б)</p>
            </div>
          </div>
          <div className="item">
            ...
            <div className="right orange">
              ...
              <h4>10:00 - 16:00</h4>
              <p>Образовательная ярмарка институтов и школ (подробная карта на обратной стороне буклета)</p>
            </div>
          </div>
          <div className="item">
        ...
        <div className="container">
          ...
          <div className="item">
            ...
            <div className="right blue">
              ...
              <h4>10:30 - 12:30</h4>
              <p>Открытие Дня открытых дверей. Пленарная дискуссия «Как поступить в лучший университет на Дальнем Востоке?» (выделить цветом на плашке)</p>
              <h4>12:30 - 14:00</h4>
